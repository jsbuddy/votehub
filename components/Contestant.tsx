...
const Contestant = ({ name = '', count = 0, percentage = 0, voted = false, voting = false, setSelected, showDetail, active = false }) => {
    return (
        <>
            <div className={`contestant ${voted && 'voted'} ${active && 'active'}`}>
